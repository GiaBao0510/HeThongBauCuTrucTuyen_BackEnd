...
-- Dumping data for table baucutructuyen.chitietthongbaocutri: ~82 rows (approximately)
...
-- Dumping data for table baucutructuyen.chitietthongbaoungcuvien: ~46 rows (approximately)
...
-- Dumping data for table baucutructuyen.danhmucungcu: ~10 rows (approximately)
...
-- Dumping data for table baucutructuyen.donvibaucu: ~5 rows (approximately)
...
-- Dumping data for table baucutructuyen.hosonguoidung: ~29 rows (approximately)
...
INSERT INTO `lichsudangnhap` (`ThoiDiem`, `DiaChiIP`, `TaiKhoan`) VALUES
	('2024-11-10 17:17:55', '127.0.0.1', 'admin2'),
	...
	('2024-11-10 18:16:36', '192.168.1.92', '0974000162'),
...
-- Dumping data for table baucutructuyen.nguoidung: ~29 rows (approximately)
INSERT INTO `nguoidung` (`ID_user`, `HoTen`, `GioiTinh`, `NgaySinh`, `DiaChiLienLac`, `CCCD`, `Email`, `SDT`, `HinhAnh`, `PublicID`, `ID_DanToc`, `RoleID`) VALUES
	...
	('bp20241109134555', 'Trần Vĩnh Tiến', '1', '2003-06-12', 'tp Bạc Liêu', NULL, 'tranvinhtien@gmail.com', '0974000888', 'null', 'null', 14, 8),
	...
	('iZ20240919194839', 'Võ Hoàng Tuấn Đạt', '1', '2002-10-29', ' tp.Cà Mau', NULL, 'lebopis479@cironex.com', '0974000162', 'http://res.cloudinary.com/dkajnklq6/image/upload/v1726750121/NguoiDung/b0pyecdhyid0q37zlpy2.jpg', 'NguoiDung/b0pyecdhyid0q37zlpy2', 1, 5),
...
-- Dumping data for table baucutructuyen.taikhoan: ~30 rows (approximately)
INSERT INTO `taikhoan` (`TaiKhoan`, `MatKhau`, `BiKhoa`, `LyDoKhoa`, `NgayTao`, `SuDung`, `RoleID`) VALUES
	...
	('0974000888', '$argon2id$v=19$m=65536,t=3,p=1$4OC/RiPyafhivUcKqxIifA$GPqn2J9Gx+ujZW/nGjmYKLIXcNDOWngwaOob8D68qgw', '0', 'null', '2024-11-09 13:45:58', 1, 5),
...
-- Dumping data for table baucutructuyen.tinhthanh: ~80 rows (approximately)
