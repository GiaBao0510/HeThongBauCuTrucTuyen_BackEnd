...
-- Dumping data for table baucutructuyen.hosonguoidung: ~0 rows (approximately)
...
-- Dumping data for table baucutructuyen.nguoidung: ~0 rows (approximately)
...
-- Dumping data for table baucutructuyen.refreshtoken: ~1 rows (approximately)
INSERT INTO `refreshtoken` (`IDrfToken`, `token`, `JwtId`, `IsUsed`, `IsRevoked`, `IssuedAt`, `ExpiredAt`, `taikhoan`) VALUES
	(9, 'ygrY2/ETzh17F3XgRCKVGGrjx28lD81mjLyIYlHCGPc=', '6919751a-ee14-4018-a54d-9f48054b01e4', 0, 0, '2024-09-15 04:06:25', '2024-09-15 14:06:25', 'admin');
...
-- Dumping data for table baucutructuyen.taikhoan: ~1 rows (approximately)
